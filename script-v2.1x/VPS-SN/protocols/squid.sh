...
fun_squid  () {
  ...
  [[ -e $var_squid ]] && {
  echo -e "\033[1;32m $(fun_trans "REMOVING SQUID")"
  msg -bar
  service squid stop > /dev/null 2>&1
  fun_bar "apt-get remove squid3 -y"
  msg -bar
  echo -e "\033[1;32m $(fun_trans "Procedure Completed")"
  msg -bar
...
msg -bar
msg -tit
msg -ama "         SQUID sinnombre-vps-master INSTALLER By @KhaledAGN"
msg -bar
fun_ip
echo -ne " $(fun_trans "Confirm your ip")\033[1;91m"; read -p ": " -e -i $IP ip
msg -bar
echo -e " $(fun_trans "\033[1;97mNow choose the ports you want on the Squid")"
echo -e " $(fun_trans "\033[1;97mSelect ports in sequential order,\n \033[1;92mEjemplo: 80 8080 8799 3128")"
msg -bar
echo -ne " $(fun_trans "Enter the ports:")\033[1;32m "; read portasx
msg -bar
totalporta=($portasx)
unset PORT
  ...
  [[ -z $PORT ]] && {
  echo -e "\033[1;31m $(fun_trans  "No valid port has been chosen")\033[0m"
  return 1
  }
msg -bar
echo -e " $(fun_trans  "INSTALLING SQUID")"
msg -bar
fun_bar "apt-get install squid3 -y"

msg -bar
echo -e " $(fun_trans  "STARTING CONFIGURATION")"
echo -e ".bookclaro.com.br/\n.claro.com.ar/\n.claro.com.br/\n.claro.com.co/\n.claro.com.ec/\n.claro.com.gt/\n.cloudfront.net/\n.claro.com.ni/\n.claro.com.pe/\n.claro.com.sv/\n.claro.cr/\n.clarocurtas.com.br/\n.claroideas.com/\n.claroideias.com.br/\n.claromusica.com/\n.clarosomdechamada.com.br/\n.clarovideo.com/\n.facebook.net/\n.facebook.com/\n.netclaro.com.br/\n.oi.com.br/\n.oimusica.com.br/\n.speedtest.net/\n.tim.com.br/\n.timanamaria.com.br/\n.vivo.com.br/\n.rdio.com/\n.compute-1.amazonaws.com/\n.portalrecarga.vivo.com.br/\n.vivo.ddivulga.com/" > /etc/payloads
msg -bar
echo -e "\033[1;32m $(fun_trans  "Now Pick A Conf For Your Proxy")"
msg -bar
echo -e "|1| $(fun_trans  "Basic")"
echo -e "|2| $(fun_trans  "Advanced")\033[1;37m"
msg -bar
read -p "[1/2]: " -e -i 1 proxy_opt
tput cuu1 && tput dl1
if [[ $proxy_opt = 1 ]]; then
echo -e " $(fun_trans  "          INSTALLING BASIC SQUID")"
elif [[ $proxy_opt = 2 ]]; then
echo -e " $(fun_trans  "          INSTALLING ADVANCED SQUID")"
else
echo -e " $(fun_trans  "          INSTALLING BASIC SQUID")"
proxy_opt=1
fi
...
echo -e "
#nome
visible_hostname sinnombre-vps-master
...
fun_eth
msg -bar
echo -ne " \033[1;31m [ ! ] \033[1;33m$(fun_trans  "    RESTARTING SERVICES")"
...
echo -e " \033[1;32m[OK]"
msg -bar
echo -e "${cor[3]}$(fun_trans  "            SQUID CONFIGURED")"
msg -bar
#UFW
...
msg -bar
echo -e "\033[1;33m$(fun_trans  "            SQUID CONFIGURED")"
msg -bar
