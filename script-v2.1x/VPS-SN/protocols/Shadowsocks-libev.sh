...
msg -bar
msg -tit
echo -e "${cor[3]}  SHADOWSOCK-LIBEV +(obfs) INSTALLER By @KhaledAGN"
msg -bar
echo -e "${cor[1]} Choose the desired option."
msg -bar
echo "1).- INSTALL SHADOWSOCK-LIBEV"
echo "2).- UNINSTALL SHADOWSOCK-LIBEV"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/khaledagn/sinnombre-vps-master_English_Official/master/LINKS-LIBRARIES/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
