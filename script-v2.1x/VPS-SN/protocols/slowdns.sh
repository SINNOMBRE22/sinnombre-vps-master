#!/bin/bash
 ...
 ini_slow(){
     ...
     if [[ ! -e ${ADM_inst}/dns-server ]]; then
     	...
     	if wget -O ${ADM_inst}/dns-server https://raw.githubusercontent.com/khaledagn/sinnombre-vps-master_English_Official/master/LINKS-LIBRARIES/dns-server &>/dev/null ; then
